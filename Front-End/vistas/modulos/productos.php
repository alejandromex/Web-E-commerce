            ...
            <div class="col-sm-6 col-xs-12">
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <li><a href="<?=$url?><?=$rutas[0]?>/1/reciente">Mas reciente</a></li>
                        <li><a href="<?=$url?><?=$rutas[0]?>/1/antiguo">Lo mas antiguo</a></li>
                    </ul>
                </div>
...
<?php
    ...
    // Llamado de categorias, subcategorias y destacados
    ...
    else if($rutas[0] == "lo-mas-visto")
    {
        ...
        $categoria = $controladorProducto->ctrMostrarCategorias($item,$valor);
        
        if(!$categoria)
        {  
            $subCategorias = $controladorProducto->ctrMostrarSubCategorias($id=null,$item,$valor);
            $item1 = "id_subcategoria";
            $valor1 = $subCategorias[0]['id'];
        }
        else{
            $item1 = "id_categoria";
            $valor1 = $categoria['id'];
    ...
    $productos = $controladorProducto->ctrMostrarProductos($ordenar,$item1,$valor1,$base,$tope,$modo);
    $listaProductos = $controladorProducto->ctrListarProductos($ordenar,$item1,$valor1);
